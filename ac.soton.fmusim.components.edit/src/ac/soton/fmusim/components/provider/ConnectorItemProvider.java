...
/**
 * This is the item provider adapter for a {@link ac.soton.fmusim.components.Connector} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Connector_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Connector_value_feature", "_UI_Connector_type"),
				 ComponentsPackage.Literals.CONNECTOR__VALUE,
				 true,
				 false,
				 false,
