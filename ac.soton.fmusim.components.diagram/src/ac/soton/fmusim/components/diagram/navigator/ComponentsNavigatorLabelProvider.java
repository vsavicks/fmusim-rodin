...
public class ComponentsNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case EventBVariableEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Node?http://soton.ac.uk/models/fmusim/components/1.0?EventBVariable", ComponentsElementTypes.EventBVariable_3008); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case EventBVariableEditPart.VISUAL_ID:
			return getEventBVariable_3008Text(view);
		case PortConnectorEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getEventBVariable_3008Text(View view) {
		IParser parser = ComponentsParserProvider.getParser(
