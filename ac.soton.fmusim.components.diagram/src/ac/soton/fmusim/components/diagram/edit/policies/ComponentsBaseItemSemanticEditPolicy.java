...
public class ComponentsBaseItemSemanticEditPolicy extends SemanticEditPolicy {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
						ComponentsVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = ComponentsElementTypes
	...
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = ComponentsDiagramEditorPlugin.getInstance()
				.getLinkConstraints();
		if (cached == null) {
			ComponentsDiagramEditorPlugin.getInstance().setLinkConstraints(
		...
		public boolean canExistPortConnector_4001(Port source, Connector target) {
			try {
				if (target == null) {
					...
					Object targetVal = ComponentsOCLFactory.getExpression(8,
