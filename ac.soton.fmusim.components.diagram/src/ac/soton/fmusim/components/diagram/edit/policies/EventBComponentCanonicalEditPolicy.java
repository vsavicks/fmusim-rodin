 ...
 * @generated
 */
public class EventBComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getEventBComponent_2002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getEventBComponent_2002SemanticChildren((View) getHost()
						.getModel());
