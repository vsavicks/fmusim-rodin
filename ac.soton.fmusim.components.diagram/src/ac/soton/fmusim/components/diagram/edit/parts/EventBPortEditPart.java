...
import ac.soton.fmusim.components.diagram.edit.policies.EventBPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EventBPortEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public EventBPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventBPortItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof EventBPortNameTypeEditPart) {
