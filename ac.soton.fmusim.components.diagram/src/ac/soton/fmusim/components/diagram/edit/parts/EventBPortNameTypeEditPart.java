 ...
 * @generated
 */
public class EventBPortNameTypeEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.fmusim.components.diagram.edit.parts.EventBPortNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public EventBPortNameTypeEditPart(View view) {
		super(view);
	}
