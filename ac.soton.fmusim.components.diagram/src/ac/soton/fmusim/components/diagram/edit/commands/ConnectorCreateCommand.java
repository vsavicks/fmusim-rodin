...
public class ConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final ComponentDiagram container;

	/**
	 * @generated
	 */
	public ConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ComponentsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConnector_4002(getContainer(), getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		Connector newElement = ComponentsFactory.eINSTANCE.createConnector();
	 ...
	 * @generated
	 */
	public ComponentDiagram getContainer() {
		return container;
	}
	 ...
	 * @generated
	 */
	private static ComponentDiagram deduceContainer(EObject source,
			EObject target) {
		...
		for (EObject element = source; element != null; element = element
			...
			if (element instanceof ComponentDiagram) {
				return (ComponentDiagram) element;
			}
		}
		return null;
	}
