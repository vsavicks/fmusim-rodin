...
public class FMUComponentVariablesCompartmentCanonicalEditPolicy extends
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getFMUComponentVariablesCompartment_7001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return VariableEditPart.VISUAL_ID == ComponentsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getFMUComponentVariablesCompartment_7001SemanticChildren((View) getHost()
						.getModel());
