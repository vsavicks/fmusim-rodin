 ...
 * @generated
 */
public class EventBInputPortCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public EventBInputPortCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		ElementInitializers.getInstance().init_EventBPort_3003(newElement);
