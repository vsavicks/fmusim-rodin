...
import ac.soton.fmusim.components.diagram.edit.policies.FMUPortItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FMUPortEditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public FMUPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FMUPortItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof FMUPortNameTypeEditPart) {
