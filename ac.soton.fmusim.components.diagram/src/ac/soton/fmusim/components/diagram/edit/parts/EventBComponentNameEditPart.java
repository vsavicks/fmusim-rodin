 ...
 * @generated
 */
public class EventBComponentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EventBComponentNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new ComponentDiagramEditPart.NodeLabelDragPolicy());
	}
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.fmusim.components.diagram.edit.parts.EventBComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					ComponentsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
