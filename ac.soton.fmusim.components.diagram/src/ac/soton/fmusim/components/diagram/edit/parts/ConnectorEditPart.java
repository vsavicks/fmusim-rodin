...
public class ConnectorEditPart extends AbstractBorderedShapeEditPart {
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof ConnectorValueEditPart) {
	...
	public void showTargetFeedback(Request request) {
		...
		if (feedbackFigure == null) {
			...
			feedbackFigure.setLineStyle(SWT.LINE_DOT);
			Rectangle bounds = getFigure().getBounds().getCopy().expand(20, 20);
	...
	/* (non-Javadoc)
	 * @see org.eclipse.gmf.runtime.diagram.ui.editparts.GraphicalEditPart#eraseTargetFeedback(org.eclipse.gef.Request)
	 */
	@Override
