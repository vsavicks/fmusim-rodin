 ...
 * @generated
 */
public class DisplayComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return ComponentsPackage.eINSTANCE.getComponent_Inputs();
	}
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getDisplayComponent_2006SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		return DisplayPortEditPart.VISUAL_ID == ComponentsVisualIDRegistry
				.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getDisplayComponent_2006SemanticChildren((View) getHost()
						.getModel());
