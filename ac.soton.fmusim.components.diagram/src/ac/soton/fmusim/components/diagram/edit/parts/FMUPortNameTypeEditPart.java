 ...
 * @generated
 */
public class FMUPortNameTypeEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ComponentsVisualIDRegistry
						.getType(ac.soton.fmusim.components.diagram.edit.parts.FMUPortNameTypeEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	 ...
	 * @generated
	 */
	public FMUPortNameTypeEditPart(View view) {
		super(view);
	}
