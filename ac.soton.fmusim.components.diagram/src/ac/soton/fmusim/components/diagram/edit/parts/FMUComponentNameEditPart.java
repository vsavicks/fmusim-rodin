 ...
 * @generated
 */
public class FMUComponentNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FMUComponentNameEditPart(View view) {
		super(view);
	}
			...
			parser = ComponentsParserProvider
					.getParser(
							...
							ComponentsVisualIDRegistry
									.getType(ac.soton.fmusim.components.diagram.edit.parts.FMUComponentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
