...
import ac.soton.fmusim.components.diagram.edit.policies.EventBPort2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class EventBPort2EditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public EventBPort2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventBPort2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof EventBPortNameType2EditPart) {
