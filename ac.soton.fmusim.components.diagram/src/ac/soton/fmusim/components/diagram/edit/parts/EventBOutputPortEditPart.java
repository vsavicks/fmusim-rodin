...
import ac.soton.fmusim.components.diagram.edit.policies.EventBOutputPortItemSemanticEditPolicy;
...
public class EventBOutputPortEditPart extends AbstractBorderItemEditPart {
	 ...
	 * @generated
	 */
	public EventBOutputPortEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new EventBOutputPortItemSemanticEditPolicy());
