 ...
 * @generated
 */
public class FMUComponentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getFMUComponent_2001SemanticChildren(viewObject);
	...
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == FMUPortEditPart.VISUAL_ID
				|| visualID == FMUPort2EditPart.VISUAL_ID;
	}
	...
	protected void refreshSemantic() {
		...
		List<ComponentsNodeDescriptor> childDescriptors = ComponentsDiagramUpdater
				.getFMUComponent_2001SemanticChildren((View) getHost()
						.getModel());
