...
import ac.soton.fmusim.components.diagram.edit.policies.FMUPort2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class FMUPort2EditPart extends BorderedBorderItemEditPart {
	 ...
	 * @generated
	 */
	public FMUPort2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new FMUPort2ItemSemanticEditPolicy());
	...
	protected void addBorderItem(IFigure borderItemContainer,
		...
		if (borderItemEditPart instanceof FMUPortNameType2EditPart) {
