 ...
 * @generated
 */
public class PortConnectorCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public PortConnectorCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ComponentsBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreatePortConnector_4001(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setConnector(getTarget());
		}
