 ...
 * @generated
 */
public abstract class ComponentsAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = ComponentsDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected ComponentsAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
