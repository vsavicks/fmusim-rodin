...
import ac.soton.fmusim.components.diagram.providers.ComponentsMarkerNavigationProvider;
import ac.soton.fmusim.components.diagram.providers.ComponentsValidationProvider;
...
public class ValidateAction extends Action {
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		ComponentsValidationProvider.runWithConstraints(txDomain,
				new Runnable() {
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			...
			View view = ComponentsDiagramEditorUtil.findView(diagramEditPart,
	...
	private static void createMarkers(IFile target,
		...
		for (Iterator it = emfValidationStatus.getChildren().iterator(); it
			...
			if (data != null && !data.isEmpty()
				...
				View view = ComponentsDiagramEditorUtil.findView(
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		ComponentsMarkerNavigationProvider.addMarker(target, elementId,
